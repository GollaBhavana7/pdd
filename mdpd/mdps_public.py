...
with st.sidebar:
    if "logged_in" not in st.session_state or not st.session_state.logged_in:
        ...
        selected = option_menu(
            'Predictive Disease Detection App',
            ['Home', 'Diabetes Prediction', 'Heart Disease Prediction', "Parkinson's Prediction", 'Logout'],
...
if st.session_state.logged_in:
    if selected == "Home":
        st.title(f"Welcome {st.session_state.name} to Predictive Disease Detection App")
        st.write("""
